<template>
<!-- 组件github地址: https://github.com/watson-yan/vue-datepicker -->
        ...
        <div class="vue-datepicker-header" @click.stop="">
          ...
          <div class="vue-datepicker-content">
              <table>
                  ...
                  <tbody>
                      <tr v-for="(week,key) of list" :key="key">
                          <td v-for="(weekday,index) of week" :key="index" @click="pick(weekday)"
                              :class="{
                                  'flag': weekday.flag,
              ...
              <div v-if="selectYear" class="vue-date-picker-year-panel">
                  <ul ref="year">
                      <li v-for="(y,iis) of years" :key="iis" @click.stop="pickYear(y)" :class="{'active': y == select.year}">{{y}}</li>
                  </ul>
                  <ul ref="month">
